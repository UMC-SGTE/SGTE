...
//Teste
//Classes de dominio, aqui estará todas as classes referente ao projeto SGTE
namespace SGTE.Dominio
{
    public class Funcionario
    {
        SGTEDATADataContext contexto = new SGTEDATADataContext();
        ...
        public string Inserir(Funcionario a) 
        {
            ...
            try {
                contexto.stp_CadastroFuncionario(a.Id, a.Funcao, a.Matricula, a.Nome, a.Endereco, a.Cidade, a.Bairro, a.CEP, a.Estado, a.Tel_Residencial, a.Tel_Celular, a.Email, a.RG, a.CPF, a.Data_Nasc, a.Sexo, null, null,null );
                resultado = "OK";
